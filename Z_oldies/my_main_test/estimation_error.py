from Z_oldies.my_main_test.our_policy_estimation_error import OurPolicyTweakedAistats
import numpy as np
import os
import json
...
class EstimationErrorExpAistats:
    ...
    def run(self, starting_checkpoint, num_checkpoints, checkpoint_duration):
        ...
        our_policy = OurPolicyTweakedAistats(switching_env=self.switching_env,
