...
from Z_oldies.my_main_test.our_policy_aistats_memoryless_v9_prove import \
    OurPolicyAistatsMemoryless
from Z_oldies.policies.epsilon_greedy import EpsilonGreedy
from Z_oldies.policies.exp3S import Exp3S
from Z_oldies.policies.oracle import OraclePolicy
from Z_oldies.policies.particle_filter import ParticleFilter
from Z_oldies.policies.sliding_window_UCB import SlidingWindowUCB
...
class CompareAlgoMemoryless:
    ...
    def generate_dirs(self):
        dir_name = f"experiments/{self.switching_env.num_states}states_{self.switching_env.num_actions}actions_{self.switching_env.num_obs}obs"
    ...
    def run(self, total_horizon,
        ...
        for n in range(self.num_experiments):
            ...
            our_policy = OurPolicyAistatsMemoryless(
                switching_env=self.switching_env,
                memoryless_policy=self.switching_env.memoryless_policy,
            ...
            for i in range(total_horizon):
                ...
                if 'our_policy' in algorithms_to_use:
                    ...
                    # our_policy.update(current_state, our_policy_chosen_arm, reward_index)
