...
from Z_oldies.policies.our_policy_aistats import OurPolicyAistats
...
class CompareAlgo:
    ...
    def run(self, total_horizon,
        ...
        algorithms_to_use = ['sliding_w_UCB', 'epsilon_greedy', 'exp3S', 'our_policy']
        ...
        for n in range(self.num_experiments):
            ...
            our_policy = OurPolicyAistats(switching_env=self.switching_env,
        ...
        plt.legend(handles=[sliding_w_UCB_patch, epsilon_greedy_patch, exp3S_patch, our_policy_patch])
