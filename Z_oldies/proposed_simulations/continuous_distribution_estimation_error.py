from Z_oldies.policies.continuous_our_policy_estimation_error import \
    OurPolicyTweakedContinuous
...
class ContinuousEstimationErrorExp:
    ...
    def __init__(self, switching_env: SwitchingBanditEnv,
        ...
        # self.generate_dirs()
        self.save_results = False       # save_results
    ...
    def run(self, starting_checkpoint, num_checkpoints, checkpoint_duration):
        ...
        for j, num_selected_arms in enumerate(num_selected_arms_list):
            ...
            our_policy = OurPolicyTweakedContinuous(switching_env=self.switching_env,
