from Z_oldies.policies.our_policy_estimation_error_v2 import OurPolicyTweakedV2
...
class EstimationErrorExpV2:
    ...
    def generate_dirs(self):
        dir_name = f"experiments_estimation_error_v2/{self.switching_env.num_states}states_{self.switching_env.num_actions}actions_{self.switching_env.num_obs}obs"
    ...
    def run(self, starting_checkpoint, num_checkpoints, checkpoint_duration):
        ...
        our_policy = OurPolicyTweakedV2(switching_env=self.switching_env,
