...
class OurPolicyTweakedV2:
    ...
    def estimate_transition_matrix(self):
        ...
        self.min_estimation_errors[update_index] = [self.t, probability_matrix_estimation_error]
        ...
        update_index = int((self.t - self.starting_checkpoint) / self.checkpoint_duration)
        self.max_estimation_errors[update_index] = [self.t, probability_matrix_estimation_error]
